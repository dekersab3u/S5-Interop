...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    <xsl:template match="/">
        <div>
            ...
            <div>
                <h3>Matin</h3>
                <p>Température : <xsl:value-of select="previsions/echeance[1]/temperature/level[@val='2m']"/> °C</p>
            ...
            <div>
                <h3>Soir</h3>
                <p>Température : <xsl:value-of select="previsions/echeance[2]/temperature/level[@val='2m']"/> °C</p>
